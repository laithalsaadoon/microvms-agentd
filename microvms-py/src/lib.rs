...
// The declarative form lists its members in the attribute, so the macro knows all 60 of them
// (44 classes and 16 functions) and the generated stub is the real surface.
//
