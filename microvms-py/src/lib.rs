...
// The declarative form lists its members in the attribute, so the macro knows all 64 of them
// (46 classes and 18 functions) and the generated stub is the real surface.
//
