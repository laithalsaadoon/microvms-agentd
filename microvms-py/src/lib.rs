...
//!
//! Launch tokens are freshly generated by default. A durable caller can supply a
...
// The declarative form lists its members in the attribute, so the macro knows all 55 of them
// (42 classes and 13 functions) and the generated stub is the real surface.
//
...
mod microvms {
    ...
    #[pymodule_export]
    use super::sandbox::{PyBaseImage, PyDetached, PyImage, PySandbox, PyTeardownReport};
    #[pymodule_export]
    use super::session::{
