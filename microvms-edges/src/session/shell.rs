...
//! ([`microvms_app::control::ControlPlane::mint_shell_auth_token`]) and is spent once, on the
...
use microvms_app::session::proxy::{WS_AUTH_SUBPROTOCOL_PREFIX, WS_SUBPROTOCOL};
