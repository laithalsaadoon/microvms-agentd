...
| `docs/reference/cli.md` | config | likely | `:3` states twenty-six subcommands and cites the clap enum in `microvms-cli/src/cli.rs`, so it restates by hand what the manifest generates |
