...
(`model/Cargo.toml:12-13`), and `conformance/run_rs.py` drives the built CLI through 188 named
checks against real AWS (`conformance/run_rs.py:9`, 5,055 LOC). Start at
