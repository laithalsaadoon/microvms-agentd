...
- [Live verification is the definition of done](solutions/repo-conventions/live-verification-is-the-definition-of-done.md) — fixtures said mvm-, the service says microvm-; live run + permanent conformance check required per AGENTS.md
