...
pub use microvms_domain::preflight::*;
...
/// `preflight` (`microvms_core::preflight::preflight`) over a resolved region and a control-plane constructor, for a caller (and a
...
mod tests {
    ...
    fn plane(transport: Arc<dyn Transport>, region: Region) -> ControlPlane {
        crate::testing::control_plane(transport, region, Arc::new(TestClock::new()))
    }
